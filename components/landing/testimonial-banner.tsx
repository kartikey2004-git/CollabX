            ...
            <div className="flex w-full flex-col justify-between p-16 lg:w-[58%]">
              <div>
                ...
                <p className="max-w-2xl text-[clamp(2.2rem,3.5vw,4.2rem)] font-medium leading-[1.08] tracking-[-0.05em] text-white">
                  Good engineering knowledge doesn&apos;t get auto-generated.
                  It gets written, reviewed, and published by people who
                  actually did the work.
                </p>
              </div>

              {/* Editorial model, not a fabricated customer quote */}
              <div className="mt-20 flex items-center gap-5">
                <div className="text-[13px] font-medium uppercase tracking-[0.2em] text-white/70">
                  — The CollabX Editorial Model
                </div>
              </div>
            </div>
