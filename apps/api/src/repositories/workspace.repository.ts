...
// workspaceRepository object is the only place that talks directly to the "Workspace" table in the database. Controllers/services call these functions instead of writing raw Prisma queries themselves.

export const workspaceRepository = {

  // Insert a new workspace row, owned by the given user.
  create(
  ...
  async findByMember(params: ListWorkspacesParams) {
    ...
    // Flatten each row so "role" sits directly on the workspace object, instead of being nested inside a "members" array.
