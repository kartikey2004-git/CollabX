...
export const projectService = {
  ...
  create(workspaceId: string, userId: string, input: CreateProjectInput): Promise<Project> {
  ...
  update(projectId: string, userId: string, input: UpdateProjectInput): Promise<Project> {
