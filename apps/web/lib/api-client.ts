...
// Where the backend API lives falls back to the local dev server if not configured.

const API_BASE_URL =
  process.env.NEXT_PUBLIC_API_URL || "http://localhost:4000";


// The shared function every API call goes through: builds the full URL, attaches cookies/JSON headers, and unwraps our API's { success, data } envelope.
