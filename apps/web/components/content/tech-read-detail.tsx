...
import { TrendingControl } from "../admin/trending-control";
    ...
    <article className="space-y-6">
      <div>
        ...
        <div className="mt-4 flex flex-wrap items-center gap-2">
          ...
          {techRead.isTrending && <Badge variant="secondary">Trending</Badge>}
      ...
      {canModerate(role) && <TrendingControl techRead={techRead} />}
