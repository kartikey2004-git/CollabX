  ...
  return (
    <section className="py-24">
      <div className="w-full px-4 sm:px-6 lg:px-10">
        <div className="relative overflow-hidden border border-white/15 bg-[#ff8a4c]">
          <div
            ...
            <div className="flex w-full flex-col justify-between p-16 lg:w-[58%]">
              <div>
                ...
                <p className="max-w-2xl text-[clamp(2.2rem,3.5vw,4.2rem)] font-medium leading-[1.08] tracking-[-0.05em] text-white">
                  There has been a lot of talk about what actually works for
                  architecture documentation. The answer is{" "}
                  <span className="font-medium">Groundwork.</span> Full stop.
                  Groundwork is the next generation of grounded, cited
              ...
              <div className="mt-20 flex items-center gap-5">
                <div className="flex h-16 w-16 items-center justify-center rounded-full bg-white text-lg font-semibold text-orange-500 shadow-lg">
                  KB
                </div>
