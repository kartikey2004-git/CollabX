        ...
        <div className="flex flex-col justify-between gap-8 pb-12 md:flex-row md:items-start">
          ...
          <div className="max-w-sm md:text-right">
            <p className="text-sm leading-relaxed text-zinc-500">
              Most teams glue together Notion, Excalidraw, and ChatGPT — and
              still ship AI answers riddled with hallucinations.
            </p>
            <p className="mt-3 text-sm leading-relaxed text-zinc-500">
              With Groundwork, every answer is grounded and cited, with zero
              auto-indexed noise.
            </p>

            <button className="mt-4 inline-flex items-center gap-2 border border-white bg-white px-4 py-2 text-xs font-medium text-black transition hover:bg-zinc-200">
              Get Started
